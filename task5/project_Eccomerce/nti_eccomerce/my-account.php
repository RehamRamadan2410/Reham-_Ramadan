...
// /////////////////////////////change-password/////////////////////////////////////
// if($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['cnange-password'])){
//     $validation->setKey('old-password')->setValue($_POST['old-password'])->required()->regex('/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,32}$/',"Minimum 8 characters,and maximum 32 , at least one uppercase letter, one lowercase letter, one number and one special character:") -> unique('users','email');
//     $validation->setKey('new-password')->setValue($_POST['new-password'])->required()->regex('/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,32}$/',"Minimum 8 characters,and maximum 32 , at least one uppercase letter, one lowercase letter, one number and one special character:")->confirmed($_POST['password_confirmation']);
...
//             // $verificationCode = new VerificationCode($_POST['email'],'change-Password Code',$body);
//             // if($verificationCode->send()){
//             //     $_SESSION['email'] = $_POST['email'];

//             //     header('location:check-code.php?page=my-account');die;
//             // }else{
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12">
                                                <div class="billing-info">
                                                    ...
                                                    <?= "<p class='text-danger font-weight-bold  '>" . $validation->getError('old-password') . "</p>" ?>
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12">
                                                <div class="billing-info">
                                                    ...
                                                    <?= "<p class='text-danger font-weight-bold  '>" . $validation->getError('new-password') . "</p>" ?>
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12">
                                                <div class="billing-info">
