...
if ($_POST) {
    ...
    if (empty($phoneNumber)) {
        $errors['phoneNumber'] = "<div class='text-danger font-weight-bold '>  Phone  Is Required </div>";
    }elseif ($phoneNumber <= 999999999){
        $errors['phoneNumber'] = "<div class='text-danger font-weight-bold '> Phone Must Be 11 number </div>";
    }
...
<body>
    ...
    <div class="container py-4 my-4 text-center mt-5 ">
        <h1 class=" my-4 text-primary "> Hospital</h1>
        ...
        <div class="row ">
            <div class="col-6 offset-3 my-3 mt-5">
                <form method="POST">
                    ...
                    <button class="btn btn-outline-success w-25  my-3">Submit</button>
                </form>
            </div>
        </div>
    </div>
