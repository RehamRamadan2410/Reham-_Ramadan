...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 03, 2022 at 03:18 AM
...
CREATE TABLE `admins` (
  ...
  `remember_tokn` varchar(255) DEFAULT NULL,
...
INSERT INTO `admins` (`id`, `name`, `code`, `phone`, `password`, `email`, `status`, `remember_tokn`, `phone_verified_at`, `email_verified_at`, `created_at`, `updated_at`) VALUES
(1, 'reham', NULL, NULL, '$2y$10$zzcMjIO4EAYw4MIzPDKmkuv3y.oaIvcqjvUKWfk4PEKlJLKBDCW0K', 'reham.ramadan2410@gmail.com', 1, NULL, NULL, '2022-06-02 17:28:55', '2022-06-02 16:28:08', '2022-06-02 17:28:55'),
(2, 'reham', NULL, NULL, '$2y$10$DFv6H9hqRH9RqfXXfgodCeM7WUOVMQJGxNPuDULQpvbjLQikfshc6', 'reham.ramadan2810@gmail.com', 1, NULL, NULL, NULL, '2022-06-02 16:40:28', '2022-06-02 16:40:28'),
(3, 'eyad', NULL, NULL, '$2y$10$cMmfhUbqXMd4lppjWezd.u6hJ8lwbjQrJF.4R4cGT6ghqD3MtmRTi', 'eyadramadan51@gmail.com', 1, NULL, NULL, NULL, '2022-06-02 17:07:05', '2022-06-02 17:07:05');
...
(9, 'جبنه رومي', 'Rumi cheese', 'Rumi is thought to be derived from the Greek kefalotyri cheese. It is the main hard cheese in Egypt.[2] It belongs to the same family as Pecorino Romano and Manchego.[3] Rumi cheese is made from cows\' milk, or from a mixture of cow and buffalo milk. No starter culture is used.[4] The milk is natural, with full cream. Peppercorns may be added.[5] After 3–4 months the cheese develops an open texture and a sharp, pungent flavor.[6] Rumi is available in 10 kilograms (22 lb) disks or as slices with variable weight in vacuum packing.[5] There are 100 calories in an ounce serving, with about 28% saturated fat.[7]', 'يُعتقد أن الرومي مشتق من جبنة الكيفالوتيري اليونانية. وهي الجبنة الصلبة الرئيسية في مصر. [2] وهي تنتمي إلى نفس عائلة بيكورينو رومانو ومانتشيجو. [3] يصنع جبن الرومي من حليب البقر ، أو من خليط من حليب البقر والجاموس. لا يتم استخدام ثقافة البادئ. [4] الحليب طبيعي كامل الدسم. يمكن إضافة حبوب الفلفل. [5] بعد 3 إلى 4 أشهر ، يكوّن الجبن قوامًا مفتوحًا ونكهة حادة لاذعة. [6] يتوفر الرومي في أقراص 10 كجم (22 رطلاً) أو شرائح ذات وزن متغير في عبوات مفرغة. [5] هناك 100 سعر حراري في الأونصة ، مع حوالي 28٪ من الدهون المشبعة. [7]', '60.00', NULL, '12345', 1, 'kAgRxF2Skh4Ko6dzLMW562I6uAuGwC491LMPqn7y.jpg', 2, NULL, '2022-06-02 23:00:40', NULL);
